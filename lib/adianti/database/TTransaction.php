...
class TTransaction
{
    ...
    public static function rollback()
    {
        if (isset(self::$conn[self::$counter]))
        {
            if (self::$conn[self::$counter] instanceof \PDO && self::$conn[self::$counter]->inTransaction())
            {
    ...
    public static function close()
    {
        if (isset(self::$conn[self::$counter]))
        {
            ...
            if (!$fake && !$muted && self::$conn[self::$counter] instanceof \PDO && self::$conn[self::$counter]->inTransaction())
            {

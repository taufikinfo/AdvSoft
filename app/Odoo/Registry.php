...
class Registry
{
    ...
    /**
     * Auto-discover and boot all model definitions from App\Odoo\Models namespace.
    ...
    public static function boot(): void
    {
        ...
        $modelsPath = app_path('Odoo/Models');
        if (is_dir($modelsPath)) {
            self::discoverModels($modelsPath, 'App\\Odoo\\Models\\');
        }

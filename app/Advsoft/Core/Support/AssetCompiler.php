...
class AssetCompiler
{
    ...
    {
        return [
            'css/advsoft-layout.css',
            'css/advsoft-dialog.css',
            'css/advsoft-list.css',
            'css/advsoft-form.css',
            'css/advsoft-menu.css',
            'css/advsoft-widgets.css',
            'css/advsoft-kanban.css',
            'css/advsoft-calendar.css',
            'css/advsoft-spreadsheet.css',
            'css/advsoft-views.css',
            'css/advsoft-inline-tree.css',
            'css/advsoft-security.css',
            'css/advsoft-menu-editor.css',
            'css/advsoft-view-builder.css',
            'css/advsoft-rte.css',
            'css/advsoft-report.css',
            'css/advsoft-dark.css',
            'css/advsoft-custom-page.css',
        ];
    }

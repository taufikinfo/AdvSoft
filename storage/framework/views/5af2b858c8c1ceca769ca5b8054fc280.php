...
<head>
    ...
    <meta name="csrf-token" content="<?= htmlspecialchars((string)(csrf_token()), ENT_QUOTES, 'UTF-8') ?>">
    <title>Larasoft — Business Applications</title>
    <meta name="description" content="Larasoft is a metadata-driven business application platform with configurable views, ORM, and Odoo-style architecture.">
    ...
    <script src="<?= htmlspecialchars((string)(asset('js/core/owl.iife.js')), ENT_QUOTES, 'UTF-8') ?>"></script>
    ...
    <?php if(app()->environment('local')): ?>
        ...
        <?php foreach($allScripts as $script): ?>
            <script src="<?= htmlspecialchars((string)(asset($script)), ENT_QUOTES, 'UTF-8') ?>?v=adianti-1.0" defer></script>
        <?php endforeach; ?>
        <!-- Styles (Unbundled) -->
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-layout.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-list.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-form.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-menu.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-widgets.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-kanban.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-calendar.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-spreadsheet.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-views.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-inline-tree.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-security.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-menu-editor.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-view-builder.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-rte.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-report.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-dark.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/odoo-custom-page.css')), ENT_QUOTES, 'UTF-8') ?>?v=38">
    <?php else: ?>
        ...
        <?php 
            if (!file_exists(public_path('js/app.bundle.js')) || !file_exists(public_path('css/app.bundle.css'))) {
                \App\Core\Support\AssetCompiler::compileAll();
            }
            $assetVer = file_exists(public_path('js/app.bundle.js')) ? filemtime(public_path('js/app.bundle.js')) : '1.0';
         ?>
        <link rel="stylesheet" href="<?= htmlspecialchars((string)(asset('css/app.bundle.css')), ENT_QUOTES, 'UTF-8') ?>?v=<?= htmlspecialchars((string)($assetVer), ENT_QUOTES, 'UTF-8') ?>">
        <script src="<?= htmlspecialchars((string)(asset('js/app.bundle.js')), ENT_QUOTES, 'UTF-8') ?>?v=<?= htmlspecialchars((string)($assetVer), ENT_QUOTES, 'UTF-8') ?>" defer></script>
    <?php endif; ?>
</head>
<body>
    <div id="app"></div>
    <script>
    window.__CSRF_TOKEN__ = '<?= htmlspecialchars((string)(csrf_token()), ENT_QUOTES, 'UTF-8') ?>';
    <?php 
        $ctx = app(\App\Odoo\Security\SecurityContext::class);
        $userArr = $ctx->toArray();
     ?>
    window.LarasoftUser = <?= json_encode($userArr) ?>;
    // ── Dark Mode Toggle ──────────────────────────
    (function() {
